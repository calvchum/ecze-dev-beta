...
import { colors, HeaderText, BodyText, SubheaderText, lineWidths, BackgroundColor } from '../utilities';
  ...
  return (
		<BackgroundColor color={colors.almostWhite}>
			...
			you’re not alone.</HeaderText>
				...
				<SubheaderText>Importantly it was found that more than half of all participants living with severe (53%) and very severe AD (54%) said doctors tell them <Underline size={lineWidths.ctaUnderline} color={colors.secondary}>there is nothing we can do.</Underline></SubheaderText>
